...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "smart trading app" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Consista — Smart Habit Tracking" },
      { name: "description", content: "smart trading app" },
      { name: "twitter:description", content: "smart trading app" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/ae79dc5f-27a6-4402-8792-e6fe688f2cd4" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/ae79dc5f-27a6-4402-8792-e6fe688f2cd4" },
    ],
